...
. link:task_adding_cloud_accounts.html#setting-up-and-adding-azure-accounts-to-cloud-manager["Concedere le autorizzazioni Azure a Cloud Manager utilizzando un'entità del servizio"].
